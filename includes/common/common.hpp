...
private:
    ...
    void set_mass(double mass) { environment.mass = mass; }
                                 
    [[nodiscard]] double get_volume() const { return environment.volume; }
    void set_volume(double volume) { environment.volume = volume; }
                                 
    [[nodiscard]] double get_temperature() const { return environment.temperature; }
    void set_temperature(double temperature) { environment.temperature = temperature; }
    ...
    void set_pressure(double pressure) { environment.pressure = pressure; }
    ...
    void set_humidity(double humidity) { environment.humidity = humidity; }
    ...
    void set_energy_consumption(double energy_consumption) { environment.energy_consumption = energy_consumption; }

    [[nodiscard]] double get_max_energy_consumption() const { return environment.max_energy_consumption; }

    [[nodiscard]] double get_heat_capacity() const { return environment.heat_capacity; }
    void set_heat_capacity(double heat_capacity) { environment.heat_capacity = heat_capacity; }
    
    [[nodiscard]] double get_thermal_conductivity() const { return environment.thermal_conductivity; }
    void set_thermal_conductivity(double thermal_conductivity) { environment.thermal_conductivity = thermal_conductivity; }
    
    [[nodiscard]] double get_surface_area() const { return environment.surface_area; }
    void set_surface_area(double surface_area) { environment.surface_area = surface_area; }
    
    [[nodiscard]] double get_wall_thickness() const { return environment.wall_thickness; }
    void set_wall_thickness(double wall_thickness) { environment.wall_thickness = wall_thickness; }
    
    [[nodiscard]] double get_wall_thermal_conductivity() const { return environment.wall_thermal_conductivity; }
    void set_wall_thermal_conductivity(double wall_thermal_conductivity) { environment.wall_thermal_conductivity = wall_thermal_conductivity; }
    
    [[nodiscard]] double get_ambient_temperature() const { return environment.ambient_temperature; }
    void set_ambient_temperature(double ambient_temperature) { environment.ambient_temperature = ambient_temperature; }
    
    [[nodiscard]] double get_heat_transfer_coefficient() const { return environment.heat_transfer_coefficient; }
    void set_heat_transfer_coefficient(double heat_transfer_coefficient) { environment.heat_transfer_coefficient = heat_transfer_coefficient; }
    
    [[nodiscard]] double get_reaction_heat_rate() const { return environment.reaction_heat_rate; }
    void set_reaction_heat_rate(double reaction_heat_rate) { environment.reaction_heat_rate = reaction_heat_rate; }
    
    [[nodiscard]] double get_cooling_rate() const { return environment.cooling_rate; }
    void set_cooling_rate(double cooling_rate) { environment.cooling_rate = cooling_rate; }
    ...
    void set_status_mode(StatusMode status_mode) { this->status_mode = status_mode; }
};